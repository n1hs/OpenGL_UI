...
namespace DoAn_OpenGL.Graphics3D
{
    ...
    {
        public TruncatedCone(DrawStyle style, double baseRadius, double height, double R, double G, double B, double tranX = 0, double tranY = 0, double tranZ = 0, double rotX = 0, double rotY = 0, double rotZ = 0)
        {
            Style = style;
            Name = "Truncated Cone";
            SizeX = baseRadius;
